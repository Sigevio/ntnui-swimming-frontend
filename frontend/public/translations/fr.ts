const fr = {
  ...
  'home': {
    'header': 'Bienvenue à NTNUI Swimming!',
    'headerDescription': '- Nous rendons la natation norvégienne plus amusante!',
    'whoHeader': 'Qui sommes nous?',
  ...
  'board': {
    ...
    'officials': ['Officials coordinator',
    ...
    'seniorMember': ['Senior Board Member',
    ...
    'members': ['Membership Accountable',
